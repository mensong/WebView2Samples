...
ProceedDataExchange::RESULT ProceedDataExchange::writePackage(const void* PData, long int dataSize, long int dataID, BOOL block)
{
	//=============ask for write lock===================
	...
	ProceedDataExchange::RESULT res = rawWritePackage(PData, dataSize, dataID);
...
ProceedDataExchange::RESULT ProceedDataExchange::readPackage(void* PData, long int dataSize, long int dataID, BOOL block)
{
	//=============ask for write lock===================
	...
	ProceedDataExchange::RESULT res = rawReadPackage(PData, dataSize, dataID);
...
ProceedDataExchange::RESULT ProceedDataExchange::readAndWritePackage(
	...
	long int dataSize, long int dataID, BOOL block)
{
	...
	ProceedDataExchange::RESULT res = rawReadPackage(pReadData, dataSize, dataID);
	    res = rawWritePackage(pWriteData, dataSize, dataID);
...
ProceedDataExchange::RESULT ProceedDataExchange::rawWritePackage(const void* PData, long int dataSize, long int dataID)
{
...
ProceedDataExchange::RESULT ProceedDataExchange::rawReadPackage(void* PData, long int dataSize, long int dataID)
{
	unsigned char newDataFlag = 1;
	long int dataOffsetIndex = 0;
	long int dataOffset = 0;
